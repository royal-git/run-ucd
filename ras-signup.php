...
$message = "<h4> Error signing up, are you sure you entered the right details? </h4>
<p><a href=\"ras.html\">Click here to go back</a></p>";
if(filter_var($email, FILTER_VALIDATE_EMAIL)){

    $file = fopen("signup-emails.txt", "a");
    fwrite($file, $name. ": " . $email. "\n");
    fclose($file);

    $message = "<h4> Thank you for signing up, we have taken note of your registration and you will be contacted via email.";
